...
export default async function CategoryPreviewPage({ params, searchParams }: Props) {
  ...
  if (currentPage > totalPages && totalPages > 0) {
    redirect(`/admin/blog/category/${slug}/preview?page=${totalPages}`)
  }

  // 記事を取得（プレビューなので全ステータス対象、作成日順、タグ情報も含める）
        ...
        {posts.length === 0 ? (
          ...
          <>
            ...
            <BlogPagination
              ...
              basePath={`/admin/blog/category/${slug}/preview`}
            />
          </>
        )}
      </div>
